...
- **Games**
  ...
  - [Shattered Pixel Dungeon](https://shatteredpixel.com/shatteredpd "shatteredpixel.com/shatteredpd") - Roguelike RPG, with pixel art graphics and lots of variety and replayability.
...
- **2D**
  ...
  - [Gimp](http://www.gimp.org "www.gimp.org") - GNU Image Manipulation Program.
    - [Bimp](https://alessandrofrancesconi.it/projects/bimp/ "alessandrofrancesconi.it/projects/bimp/") - Batch Image Manipulation Plugin for GIMP, it has a [git repository](https://github.com/alessandrofrancesconi/gimp-plugin-bimp "https://github.com/alessandrofrancesconi/gimp-plugin-bimp").
    - [Export Layers](https://github.com/khalim19/gimp-plugin-export-layers "https://github.com/khalim19/gimp-plugin-export-layers") - Exports layers as separate images. A use case: when importing a pdf document with multiple pages on separate layers and then the user can export the layers as separate images.
...
- **Video**
  - **[Avidemux](http://avidemux.sourceforge.net "avidemux.sourceforge.net")** - Free video editor designed for simple cutting, filtering and encoding tasks.
  ...
  - **[OpenShot](https://www.openshot.org "openshot.org")** - Video Editor easy to use, quick to learn, and surprisingly powerful.
...
- [Xournal++](https://github.com/xournalpp/xournalpp "github.com/xournalpp/xournalpp") - Handwriting notetaking software with PDF annotation, supports pen input from devices such as Wacom Tablets.
...
- **Customizations**
  ...
  - Themes
    ...
    - [Plane icon theme](https://github.com/wfpaisa/plane-icon-theme "https://github.com/wfpaisa/plane-icon-theme") - Modern icon theme for gnome linux versions.
- **Utilities**
